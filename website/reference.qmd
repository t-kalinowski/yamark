...
| `--wrap sentence:<n>` | Put each Markdown sentence on its own line and wrap long sentences to column `<n>`. This is the default at column 72. |
| `--wrap <n>` | Wrap Markdown prose to column `<n>` without forcing sentence boundaries. |
