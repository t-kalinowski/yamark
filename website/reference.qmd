...
```{r}
#| label: setup-reference-examples
#| include: false
source("_yamark-build.R")

reference_before_after <- function(before, lang, stdin_file_path) {
  before <- trim_one_trailing_newline(before)
  after <- yamark_format(before, stdin_file_path)
...
```{r}
#| label: reference-hashpipe-before-after
#| results: asis
reference_before_after(
  before = r"---(#| name: demo
#| launcher:
#|  vanilla: true
...
```{r}
#| label: reference-collapse-sequence-before-after
#| results: asis
reference_before_after(
  before = r"---(tags: [
  - yaml
...
```{r}
#| label: reference-collapse-mapping-before-after
#| results: asis
reference_before_after(
  before = r"---(config: {
  host: example.com
...
```{r}
#| label: reference-expand-mapping-before-after
#| results: asis
reference_before_after(
  before = r"---(- {a: b,
   c: d}
