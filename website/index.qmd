...
```{r}
#| label: homepage-benchmark-overview
#| echo: false
#| results: asis

write_benchmark_chart(
  kind = "overview",
  id = "homepage-benchmark-overview",
  title = "Yamark and the next-lowest elapsed time",
  subtitle = paste(
    "Median wall time for each generated workload.",
    "Lower is better; the horizontal scale is logarithmic."
  ),
